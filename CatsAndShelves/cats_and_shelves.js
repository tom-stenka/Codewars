...
{
  shelvDiff = finish - start;
  let longJumps = Math.floor(shelvDiff / 3);
  let longJumpDist = longJumps * 3; 
  let shortJumps = shelvDiff - longJumpDist; 
  let numberOfJumps = longJumps + shortJumps; 
